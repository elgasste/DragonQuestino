...
#define STRING_OVERWORLD_DIALOG_SPELLS_OVERWORLD_CASTHEAL_RESULT_1   "You have recovered %s hit point."
#define STRING_OVERWORLD_DIALOG_SPELLS_OVERWORLD_CASTHEAL_RESULT_2   "You have recovered %s hit points."
