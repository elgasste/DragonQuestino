...
#define STRING_BATTLE_ATTACKEXCELLENTMOVE                            "Excellent move! The %s has lost %u hit %s. Command?"
#define STRING_BATTLE_ATTACKATTEMPTSUCCEEDEDVICTORY                  "The %s has lost %u hit %s."
#define STRING_BATTLE_ATTACKEXCELLENTMOVEVICTORY                     "Excellent move! The %s has lost %u hit %s."
