...
#define ANIMATION_BATTLE_PLAYERDEATH_DURATION            0.6f
#define ANIMATION_BATTLE_PLAYERDEATH_FRAMEDURATION       0.025f
#define ANIMATION_BATTLE_PLAYERDEATH_FLASHFRAMES         2
